                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <ul class="nav nav-tabs tab-nagative-m" role="tablist">
                                    <div class="dropdown">
                                        <a href="#" class="dropdown-toggle btn btn-secondary btn-sm " data-bs-toggle="dropdown" aria-expanded="false">
                                            Export To
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="#!" class="dropdown-item">Download</a>
                                            <a href="{{ route('order.order.export') }}" class="dropdown-item">Export</a>
                                            <a href="{{ route('order.order.export.excel') }}" class="dropdown-item">Export to Excel</a>
                                        </div>
                                    </div>
                                    <li class="nav-item">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                $no = $orders->firstItem() + $i;
                                                $productName = $item->product->name ?? 'N/A';
                                                $productPrice = number_format($item->product->price ?? 0, 0, ',', '.');
                                                $tanggal = in_array($item->status, [1, 2, 3]) ? $item->updated_at : $item->created_at;
                                                ...
                                                case 1:
                                                $status = "PROGRESS";
                                                $class = "text-info"; // biru muda (karena kuning dan orange sama-sama warning)
                                                break;
                                                case 2:
                                                $status = "DECLINE";
                                                $class = "text-danger"; // merah
                                                break;
                                                case 3:
                                                $status = "SELESAI";
                                                $class = "text-success"; // hijau
                                                break;
                                                default:
                                                $status = "-";
                                                $class = "";
