    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            Swal.fire({
                ...
                text: {!! json_encode(session('cancel')) !!},
                timer: 3000,
                showConfirmButton: false
            });
            @endif
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                <li>
                                    <a role="button" href="{{ route('order.tampilP') }}" class="btn btn-secondary btn-sm ">Progress</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="table-responsive dash-social">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($orders->where('status', 0) as $order)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('order.decline', $order->id) }}" method="POST" style="display:inline">
                                                        @csrf
                                            ...
                                            @empty
                                            <tr>
                                                <td colspan="5">Tidak ada transaksi pending.</td>
                                            </tr>
                                            @endforelse
                                            <!--end tr-->
                                        </tbody>
